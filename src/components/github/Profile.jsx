                ...
                <div className="col-md-8">
                  <div className="row">
                    <div className="col-md-12">
                      ...
                      </span><span className="label label-success">
                        {this.props.userData.public_gist} Public Gist
                      </span>
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <ul className="list-group">
                        ...
                        <li className="list-group-item"><strong>Locatio: </strong> {this.props.userData.location}</li>
